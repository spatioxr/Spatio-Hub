...
CREATE TABLE IF NOT EXISTS public.employees (
  ...
  role TEXT NOT NULL DEFAULT 'employee'
    CHECK (role IN ('superadmin', 'admin', 'manager', 'head', 'employee')),
...
CREATE POLICY "employees_select_self_or_superadmin"
...
CREATE POLICY "employees_link_own_auth_or_superadmin"
...
CREATE POLICY "attendance_select_own_or_superadmin"
  ON public.attendance FOR SELECT TO authenticated
  USING (employee_id = public.current_employee_id() OR public.is_superadmin());

CREATE POLICY "attendance_insert_own_or_superadmin"
...
CREATE POLICY "daily_reports_select_own_or_superadmin"
  ON public.daily_reports FOR SELECT TO authenticated
  USING (employee_id = public.current_employee_id() OR public.is_superadmin());

CREATE POLICY "daily_reports_insert_own_or_superadmin"
...
CREATE POLICY "leaves_insert_own_or_superadmin"
  ON public.leaves FOR INSERT TO authenticated
  WITH CHECK (employee_id = public.current_employee_id() OR public.is_superadmin());

CREATE POLICY "leaves_update_own_or_superadmin"
