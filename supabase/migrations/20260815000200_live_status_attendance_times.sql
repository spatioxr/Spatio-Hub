-- Feedback SI1 / HRMS-020: the live board reports attendance times, not
-- context-switch timestamps. Keep first_check_in_at as a compatibility alias
-- for the already-deployed frontend while adding explicit attendance fields.
