-- HRMS-020: keep the live board's In time anchored to the first check-in of
-- the current Asia/Kolkata workday when a context switch opens a new entry.
...
AS $$
  SELECT
    ...
    CASE
      ...
      ELSE COALESCE(first_entry_today.started_at, open_entry.started_at)
